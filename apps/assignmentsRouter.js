...
assignmentRouter.get("/accounts", function (req, res) {
  res.send("View all accounts");
});

assignmentRouter.get("/accounts/:id", function (req, res) {
  res.send("View an account by id");
});

assignmentRouter.post("/accounts", function (req, res) {
  res.send("Create an account");
});

assignmentRouter.put("/accounts/:id", function (req, res) {
  res.send("Update an account by id");
});

assignmentRouter.delete("/accounts/:id", function (req, res) {
